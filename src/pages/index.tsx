        ...
        <div className="max-w-lg mx-auto bg-neutral-800 py-5 rounded-lg">
          <form onSubmit={(e) => {
            ...
            <div className="px-4">
              ...
              <input autoFocus={true} className="w-full py-2 px-2 rounded-full mb-3 bg-neutral-600 focus:ring-white text-white" value={roomId} onChange={(e) => setRoomId(e.currentTarget.value)} />
